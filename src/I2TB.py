...
# Removido o horário "22:45"
horarios = ["07:00", "08:20", "11:00", "14:00", "18:00", "20:00"]

I = range(len(regionais))
T = range(len(horarios))

B = 40
# Removido o último valor (120) correspondente a 22:45
F = [180, 100, 60, 60, 150, 80]

# Removido o último valor de cada sublista (correspondente a 22:45)
d = [
    [850, 400, 150, 200, 600, 300],
    [250, 120, 50, 80, 200, 100],
    [500, 250, 100, 120, 450, 150],
    [600, 300, 150, 180, 500, 200],
    [200, 100, 50, 60, 180, 80],
    [950, 450, 200, 250, 700, 350],
    [400, 200, 80, 100, 350, 150],
    [350, 180, 60, 90, 300, 120],
    [300, 150, 50, 80, 250, 100],
    [450, 220, 90, 110, 400, 180],
    [500, 250, 100, 130, 450, 200],
    [700, 350, 130, 180, 600, 250],
    [400, 200, 70, 100, 350, 150],
    [380, 190, 60, 90, 320, 140],
]
